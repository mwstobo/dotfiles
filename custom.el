(custom-set-variables
 ...
 '(package-selected-packages
   '(terraform-mode kotlin-mode docker-compose-mode lsp-treemacs lsp-java pkgbuild-mode dockerfile-mode magit yasnippet company which-key flycheck lsp-mode go-mode use-package))
 '(tab-width 4)
 '(tool-bar-mode nil))
(custom-set-faces
